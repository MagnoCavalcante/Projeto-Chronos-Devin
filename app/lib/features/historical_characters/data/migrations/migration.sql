-- Migration para a tabela de HistoricalCharacters no ecossistema CHRONOS
...
ALTER TABLE public.historical_characters ENABLE ROW LEVEL SECURITY;

-- Políticas de RLS para acesso público de leitura
CREATE POLICY "Leitura pública permitida para registros ativos" ON public.historical_characters
